...
# Correct velocity unit to km/s in the fits header.
# Somehow CASA exported FITS images that are plotted with aplpy are
# always off in velocity. I have no idea why. This script fixes that 
# problem by changing the velocity scale and header. However it needs 
# to be overcorrected for aplpy to display correctly.
